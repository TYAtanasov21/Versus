...
const Footer: React.FC<FooterProps> = ({ className }) => {
    return (
        <div className={`flex flex-row bg-sky-950 rounded-t-lg justify-between mr-16 ${className}`}>
            ...
            <h1 className="text-2xl font-extrabold text-white pb-2 text-medium ml-10 md:text-large md:text-bold font-sans">Start Chatting With<br/> Friends Now</h1>
            </div>
            <div className="flex flex-col justify-center items-center mr-4">
                <h1 className="text-2xl font-extrabold text-white pb-2 font-serif">Join our newsletter!</h1>
